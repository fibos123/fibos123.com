"use client"; // Required for hooks like useMonitor and client-side interactions

import Link from "next/link";
import { useMonitor } from "../../hooks"; // Adjust path as needed
import { formatDate, formatNumber } from "../../utils"; // Adjust path as needed
